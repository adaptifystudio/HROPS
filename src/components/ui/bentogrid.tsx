  ...
  return (
    <div className="mx-auto my-20 w-full max-w-7xl px-4 md:px-8">
      <div className="mt-20 grid grid-flow-col grid-cols-1 grid-rows-6 gap-2 md:grid-cols-2 md:grid-rows-3 xl:grid-cols-3 xl:grid-rows-2">
        {/* Stratégie et Transformation Digitale RH */}
        <Card className="row-span-2">
          <CardContent>
            <CardTitle>Stratégie et Transformation Digitale RH</CardTitle>
            <CardDescription>
              Élaboration d'une stratégie globale pour moderniser vos processus
              RH, incluant un diagnostic digital et une feuille de route
              personnalisée.
            </CardDescription>
          </CardContent>
          <CardSkeletonBody>
        ...
        {/* Déploiement de Solutions SIRH */}
        <Card className="overflow-hidden">
          <CardContent>
            <CardTitle>Déploiement de Solutions SIRH</CardTitle>
            <CardDescription>
              Gestion complète du déploiement SIRH avec sélection, intégration
              personnalisée et optimisation des solutions selon vos besoins.
            </CardDescription>
          </CardContent>
          <CardSkeletonBody>
            <SkeletonTwo />
        ...
        {/* Optimisation des Systèmes RH Existants */}
        <Card>
          <CardContent>
            <CardTitle>Optimisation des Systèmes RH Existants</CardTitle>
            <CardDescription>
              Amélioration continue de votre SIRH existant avec audit, suivi et
        ...
        <Card className="row-span-2">
          <CardContent>
            <CardTitle>Assistance à Maîtrise d'Ouvrage (AMOA)</CardTitle>
            <CardDescription>
              Traduction de vos besoins métiers en solutions concrètes avec
              cahier des charges, appels d'offres et gestion de projet.
            </CardDescription>
          </CardContent>
  ...
  const Highlighter = () => {
    return (
      <motion.div layoutId="highlighter" className="absolute inset-0">
        <div className="absolute -left-px -top-px h-4 w-4 rounded-tl-lg border-l-2 border-t-2 border-orange-500 bg-transparent"></div>
        <div className="absolute -right-px -top-px h-4 w-4 rounded-tr-lg border-r-2 border-t-2 border-orange-500 bg-transparent"></div>
        <div className="absolute -bottom-px -left-px h-4 w-4 rounded-bl-lg border-b-2 border-l-2 border-orange-500 bg-transparent"></div>
        <div className="absolute -bottom-px -right-px h-4 w-4 rounded-br-lg border-b-2 border-r-2 border-orange-500 bg-transparent"></div>
      </motion.div>
    );
  };
          ...
          <div className="relative mx-auto w-full max-w-xs">
            ...
            {!files.length && (
              <motion.div
                ...
                className="absolute inset-0 z-30 mx-auto mt-4 flex h-32 w-full max-w-[8rem] items-center justify-center rounded-md border border-dashed border-orange-500 bg-transparent opacity-0"
              ></motion.div>
            )}
          </div>
        </div>
